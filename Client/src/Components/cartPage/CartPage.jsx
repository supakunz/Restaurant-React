        ...
        <div className='container-section py-[100px]'>
                  ...
                  <tr>
                    ...
                    <td className='border border-[#cdcdcd]'>
                      <div className='flex justify-center'>
                        <p className='p-[5px_12px] text-blackBlue text-[12px] lg:text-[14px] bg-yellow rounded-full '>{item.category}</p>
                      </div>
                    </td>
                    <td className='border border-[#cdcdcd] text-[14px] lg:text-[16px]'>{item.price}$</td>
                    <td className='border border-[#cdcdcd]'>
          ...
          <div className='mt-8 flex flex-col md:flex-row justify-between'>
            <div className='flex h-[2.7rem]'>
              <input className='w-full md:w-[12rem] lg:w-[13.5em] border-solid border-y-[1px] border-l-[1px] border-[#cdcdcd]' type="text" />
              <button className='bg-yellow p-[0.5rem] w-[9rem] sm:w-[8rem] md:w-[7.5rem] lg:p-[0.7rem text-[14px] lg:text-[15px] hover:bg-yellowHover '>Apply Coupon</button>
            </div>
            <div>
              <div className='bg-white p-5 h-[16rem] w-full md:w-[22rem] mt-7 md:mt-0 mb-5 flex flex-col gap-4'>
                <h1 className='text-[20.5px] lg:text-[23px] font-semibold mb-[0.6rem]'>Cart totol</h1>
              ...
              <button className='bg-yellow p-[0.7rem] w-full text-[17px] lg:text-[18px] rounded-md hover:bg-yellowHover'>Proceed to Checkout</button>
            </div>
          </div>
        </div>
      </section>
